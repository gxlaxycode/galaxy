...
module.exports = class Client extends EventEmitter {
    ...
    handleauth(message) {
        ...
        this.botJid = `ZeroBot@prod.ol.epicgames.com/V2:Fortnite:WIN::${parsed[0]}`
    ...
    handlemessage(message) {
		...
		'!Backpack     Set first bots backbling (random=none)' + '\n' +
            ...
            if (msg.startsWith("!skin ")) {
                ...
                axios.get(`https://fortnite-api.com/v2/cosmetics/br/search?name=${name}&matchMethod=contains&type=outfit`).then(response => {
                    ...
                    fs.writeFile('./config/ZeroBot/config.json', JSON.stringify({
                ...
                'body': {
                    "#text": JSON.stringify({
                        ...
                        "member_state_updated": {
                            "urn:epic:member:dn_s": "ZeroBot",
                            "urn:epic:member:joinrequestusers_j": "{\"users\":[{\"id\":\"ZeroBot\",\"dn\":\"ZeroBot\",\"plat\":\"WIN\",\"data\":\"{\\\"CrossplayPreference_i\\\":\\\"1\\\",\\\"SubGame_u\\\":\\\"1\\\"}\"}]}"
                        },
                        "joined_at": new Date(),
                        "updated_at": new Date()
                    })
    ...
    JoinBot(PartyId) {
        ...
        setTimeout(() => {
                        ...
                        "#text": JSON.stringify(
                            {
                                ...
                                "member_state_updated": {
                                    ...
                                    "Default:AthenaBannerInfo_j": "{\"AthenaBannerInfo\":{\"bannerIconId\":\"NewsletterBanner\",\"bannerColorId\":\"defaultcolor22\",\"seasonLevel\":999}}",
            ...
            try {
                global.BotConfig = JSON.parse(fs.readFileSync('./config/ZeroBot/config.json', 'utf8', function (err, data) {
                    ...
                    "#text": JSON.stringify(
                        {
                            ...
                            "type": "com.epicgames.social.party.notification.v0.MEMBER_JOINED",
                            "connection": {
                                "id": `ZeroBot${this.NumberOfBot}@prod.ol.epicgames.com/V2:Fortnite:WIN::BOT${this.NumberOfBot}`,
                                "meta": {
                                    "urn:epic:conn:platform_s": "WIN",
                                    "urn:epic:conn:type_s": "game"
                                },
                            ...
                            "ns": "Fortnite",
                            "party_id": PartyId,
                            "account_id": `ZeroBot${this.NumberOfBot}`,
                            "account_dn": `ZeroBot`,
                            "member_state_updated": {
                                "urn:epic:member:joinrequestusers_j": `{\"users\":[{\"id\":\"ZeroBot${this.NumberOfBot}\",\"dn\":\"ZeroBot\",\"plat\":\"WIN\",\"data\":\"{\\\"CrossplayPreference_i\\\":\\\"1\\\",\\\"SubGame_u\\\":\\\"1\\\"}\"}]}`,
                                "urn:epic:member:dn_s": `ZeroBot`
                            },
                            "joined_at": new Date(),
                            "updated_at": new Date()
                        ...
                        "#text": JSON.stringify(
                            {
                                ...
                                "member_state_updated": {
                                    ...
                                    "Default:SpectateAPartyMemberAvailable_b": "false",
                                    "Default:UtcTimeStartedMatchAthena_s": "0001-01-01T00:00:00.000Z",
                                    "Default:AthenaCosmeticLoadout_j": `{\"AthenaCosmeticLoadout\":{\"characterDef\":\"/Game/Athena/Items/Cosmetics/Characters/CID_286_Athena_Commando_F_NeonCat.CID_286_Athena_Commando_F_NeonCat\",\"characterEKey\":\"\",\"backpackDef\":\"null\",\"backpackEKey\":\"\",\"pickaxeDef\":\"/Game/Athena/Items/Cosmetics/Pickaxes/Pickaxe_ID_288_RebirthMedicFemale.Pickaxe_ID_288_RebirthMedicFemale\",\"pickaxeEKey\":\"\",\"contrailDef\":\"/Game/Athena/Items/Cosmetics/Contrails/Trails_ID_087_TNTina.Trails_ID_087_TNTina\",\"contrailEKey\":\"\",\"scratchpad\":[]}}`,
                    ...
                    "#text": JSON.stringify(
                        {
                            ...
                            "member_state_updated": {
                                ...
                                "Default:VoiceChatStatus_s": "PartyVoice",
                                "Default:SidekickStatus_s": "None",
                                "Default:AthenaCosmeticLoadout_j": `{\"AthenaCosmeticLoadout\":{\"characterDef\":\"/Game/Athena/Items/Cosmetics/Characters/${cid}.${cid}\",\"characterEKey\":\"\",\"backpackDef\":\"null\",\"backpackEKey\":\"\",\"pickaxeDef\":\"/Game/Athena/Items/Cosmetics/Pickaxes/Pickaxe_ID_288_RebirthMedicFemale.Pickaxe_ID_288_RebirthMedicFemale\",\"pickaxeEKey\":\"\",\"contrailDef\":\"/Game/Athena/Items/Cosmetics/Contrails/Trails_ID_087_TNTina.Trails_ID_087_TNTina\",\"contrailEKey\":\"\",\"scratchpad\":[]}}`,
                                "Default:AthenaCosmeticLoadoutVariants_j": "{\"AthenaCosmeticLoadoutVariants\":{\"vL\":{\"AthenaPickaxe\":{\"i\":[{\"c\":\"Mesh\",\"v\":\"Stage0\",\"dE\":0}]},\"AthenaCharacter\":{\"i\":[{\"c\":\"Progressive\",\"v\":\"Stage2\",\"dE\":0},{\"c\":\"Material\",\"v\":\"Mat1\",\"dE\":0}]},\"AthenaBackpack\":{\"i\":[{\"c\":\"Material\",\"v\":\"Mat2\",\"dE\":0}]}}}}",
                                "Default:ArbitraryCustomDataStore_j": "{\"ArbitraryCustomDataStore\":[]}",
                                "Default:AthenaBannerInfo_j": "{\"AthenaBannerInfo\":{\"bannerIconId\":\"NewsletterBanner\",\"bannerColorId\":\"defaultcolor22\",\"seasonLevel\":999}}",
                                "Default:BattlePassInfo_j": "{\"BattlePassInfo\":{\"bHasPurchasedPass\":false,\"passLevel\":6,\"selfBoostXp\":0,\"friendBoostXp\":0}}",
